    ...
    loadRetailPaypalSdk(paypalClientId, currency).then(() => {
      ...
      window.paypal.Buttons({
        ...
        onApprove: async ({ orderID }) => {
          ...
          setMessage(response.ok ? (locale === "ar" ? "تم استلام الطلب." : "Order received.") : (locale === "ar" ? "تعذر إتمام الدفع." : "Payment could not be completed."));
        },
